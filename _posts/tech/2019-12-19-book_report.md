...
&nbsp;
 주니어 시기에는 정말 열심히 배워야 한다는 말을 많이 들었다. 배우는 방법 중 스스로 학습하는 방법과 다른 사람을 통해 배우는 방법이 있을 것 같다. 스스로 학습하는 방법도 정말 중요하지만 주니어 시기에는 다른 개발자들에게 배우는 것이 아주 중요한 시기인것 같다. 구성원들의 지식의 깊음을 수치화하고 시각화 한다면 피라미드와 비슷할 것 같다. 내가 아직 지식의 깊음이 낮다면 오히려 다른 사람에게 배울 수 있는 기회가 아주 많고 더 빠르게 성장할 수 있을 것이라고 생각이 들었다. 하지만 자신 스스로가 마스터의 경지에 이르렀다면 피라미드의 꼭대기 근처에 이르렀을 것이고 주니어 시기보다 다른 사람에게 배울 수 있는 기회가 훨씬 줄어들 것이라는 생각이 들었다.
