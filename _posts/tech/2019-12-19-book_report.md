...
&nbsp;
 요즘 다수의 회사들은 MSA 환경을 지향하고 있어 부서별로 권한이 명확해진 덕분에 개발자들이 더욱 자신의 담당 프로젝트에 주인의식을 갖기 쉬운 환경이 조성됐다는 생각이 들었다. 주니어개발자로서 주인의식을 갖고 행동하는 모습이 어떤 것일지 생각해봤다. 장애처리에 적극적으로 참여하고 레거시 코드를 적극적으로 리펙토링하고 테스트코드를 적극적으로 작성하는 모습이지 않을까.
