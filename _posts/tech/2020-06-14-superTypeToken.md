...
# 시작하며..  🚗
 &nbsp; 혹시 수퍼 타입 토큰이라는 단어를 들어보셨나요? 저는 정확한 동작원리를 알지 못하고 사용만 해봤었습니다. 😵
 그래서 수퍼 타입 토큰이 무엇이고 어떻게 활용될 수 있는지 처음부터 쭉 조사하고 정리해보는 시간을 가져봤습니다. 🤗
 제가 궁금했던 질문을 목차로 만들어 봤는데요 ㅎㅎ 이 순서로 쭉 정리해보겠습니다. 😁 <br/>
